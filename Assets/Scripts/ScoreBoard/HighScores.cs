...
{
    const string privateCode = "UG3sE_zrj0eQKPpBhtQrQwcd_dZIvmgk2hUmqgO8-WOA";  //Key to Upload New Info
    const string publicCode = "617074d28f40bba8b4eb261b";   //Key to download
    ...
    {
        UnityWebRequest www = UnityWebRequest.Post(webURL + privateCode + "/add/" + UnityWebRequest.EscapeURL(username) + "/", score.ToString());
